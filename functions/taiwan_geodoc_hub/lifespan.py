...
from taiwan_geodoc_hub.modules.system_maintaining.domain.ports.bytes_hasher import (
    BytesHasher,
)
...
from taiwan_geodoc_hub.infrastructure.http.ocr_space import OCRSpace
